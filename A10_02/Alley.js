...
(function (L10_Luftfahrt_Classes) {
    ...
    */
    ...
    function handleLoad(_event) {
        ...
        crc2 = L10_Luftfahrt_Classes.canvas.getContext("2d");
        ...
        for (let x = 0; x < 250; x++) {
            ...
            let randomY = (Math.random() * crc2.canvas.height / golden) + golden * L10_Luftfahrt_Classes.canvas.height;
        ...
        drawTree(242, 841);
        drawBoot(1020, 735);
        bgImage = crc2.getImageData(0, 0, L10_Luftfahrt_Classes.canvas.width, L10_Luftfahrt_Classes.canvas.height);
        drawPeople();
        createGliders(10);
        drawGliders();
    ...
    function createGliders(_amount) {
        for (let i = 0; i < _amount; i++) {
            let aviator = new L10_Luftfahrt_Classes.Aviator(randomVector(L10_Luftfahrt_Classes.canvas.width, golden * L10_Luftfahrt_Classes.canvas.height), randomVector(10, 10), randomColor());
